...
{{
var G__5659 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5659;
continue;
}
} else
...
{var pred__5663 = cljs.core._EQ_;var expr__5664 = limit;if(cljs.core.truth_(pred__5663.call(null,1,expr__5664)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5663.call(null,2,expr__5664)))
...
var G__5666 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5667 = (limit__$1 - 1);
var G__5668 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5666;
limit__$1 = G__5667;
parts = G__5668;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5670 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5670))
{var replacement_5671 = temp__4090__auto___5670;buffer.append([cljs.core.str(replacement_5671)].join(''));
} else
{buffer.append(ch);
}
{
