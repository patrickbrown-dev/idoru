...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15042 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15042 = (function (val,box,meta15043){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15042.cljs$lang$type = true;
cljs.core.async.impl.channels.t15042.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15042";
cljs.core.async.impl.channels.t15042.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t15042");
});
cljs.core.async.impl.channels.t15042.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15042.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15044){var self__ = this;
var _15044__$1 = this;return self__.meta15043;
});
cljs.core.async.impl.channels.t15042.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15044,meta15043__$1){var self__ = this;
var _15044__$1 = this;return (new cljs.core.async.impl.channels.t15042(self__.val,self__.box,meta15043__$1));
});
cljs.core.async.impl.channels.__GT_t15042 = (function __GT_t15042(val__$1,box__$1,meta15043){return (new cljs.core.async.impl.channels.t15042(val__$1,box__$1,meta15043));
});
}
return (new cljs.core.async.impl.channels.t15042(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15045 = self__.takes.pop();if((taker_15045 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15045))
{var take_cb_15046 = cljs.core.async.impl.protocols.commit.call(null,taker_15045);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15046,taker_15045,this$__$1){
return (function (){return take_cb_15046.call(null,null);
});})(take_cb_15046,taker_15045,this$__$1))
);
} else
{}
{
...
var putter_15047 = self__.puts.pop();if(!((putter_15047 == null)))
{var put_handler_15048 = putter_15047.handler;var val_15049 = putter_15047.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15048))
{var put_cb_15050 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15048);var __15051__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15050,__15051__$1,put_handler_15048,val_15049,putter_15047,_,retval,this$__$1){
return (function (){return put_cb_15050.call(null,true);
});})(put_cb_15050,__15051__$1,put_handler_15048,val_15049,putter_15047,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_15049);
} else
{{
continue;
}
