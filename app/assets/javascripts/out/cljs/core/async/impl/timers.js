...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14943 = (0);while(true){
if((i_14943 < arr.length))
{(arr[i_14943] = null);
{
...
{var i_14950 = (self__.level + (1));while(true){
if((i_14950 <= (new_level + (1))))
{(update[i_14950] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14952 = (0);while(true){
if((i_14952 <= self__.level))
{var links_14953 = (update[i_14952]).forward;if(((links_14953[i_14952]) === x__$1))
{(links_14953[i_14952] = (x__$1.forward[i_14952]));
{
var G__14954 = (i_14952 + (1));
i_14952 = G__14954;
continue;
}
} else
{{
var G__14955 = (i_14952 + (1));
i_14952 = G__14955;
continue;
}
}
