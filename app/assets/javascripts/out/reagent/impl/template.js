...
{return (function() { 
var G__10510__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__10513 = o;(G__10513[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__10513;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__10514){var vec__10516 = p__10514;var id = cljs.core.nth.call(null,vec__10516,(0),null);var class$ = cljs.core.nth.call(null,vec__10516,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_10517 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_10517 === "key")))
{(o[pname_10517] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__10520 = jsprops;(G__10520["defaultValue"] = value);
(G__10520["value"] = null);
(G__10520["onChange"] = ((function (G__10520,on_change,value){
return (function (p1__10518_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10518_SHARP_);
});})(G__10520,on_change,value))
);
return G__10520;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__10522 = spec;(G__10522["componentDidUpdate"] = ((function (G__10522){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__10522))
);
(G__10522["componentWillUnmount"] = ((function (G__10522){
...
return (function (p1__10523_SHARP_,p2__10524_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__10523_SHARP_,p2__10524_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__10526 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__10526,(0),null);var id = cljs.core.nth.call(null,vec__10526,(1),null);var class$ = cljs.core.nth.call(null,vec__10526,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__10528 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__10528,(0),null);var id_class = cljs.core.nth.call(null,vec__10528,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_10529 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__10530 = (((k_10529 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_10529);if((k_SINGLEQUOTE__10530 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__10530);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4510__auto___10531 = a.length;var i_10532 = (0);while(true){
if((i_10532 < n__4510__auto___10531))
{(a[i_10532] = reagent.impl.template.as_component.call(null,(a[i_10532]),level_SINGLEQUOTE_));
{
