class Admin::SubscriptionsController < Admin::BaseAdminController
  ...
  def create
    ...
    redirect_to admin_subscriptions_path, flash: { success: "Subscription created" }
  ...
  def update
    ...
    redirect_to admin_subscriptions_path, flash: { success: "Subscription updated" }
  rescue ActiveRecord::RecordInvalid => e
  ...
  def destroy
    ...
    redirect_to admin_subscriptions_path, flash: { success: "Subscription destroyed" }
  end
