...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15036 = (0);while(true){
var m_15037 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15037 == null))
{} else
{m_15037.call(null);
if((count_15036 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15038 = (count_15036 + (1));
count_15036 = G__15038;
continue;
}
} else
{}
